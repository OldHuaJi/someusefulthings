...
public class CopyEnchantmentTileEntity extends TileEnergyHandler implements ITickable
{
	...
	public void update()
	{
		if (!this.worldObj.isRemote)
		{
			...
			if (itemStack_0 != null && itemStack_1 != null && itemStack_2 != null
					&& iInventory.insertItemMe(3, itemStack_3, true) == null && itemStack_1.stackSize == 16)
			{
