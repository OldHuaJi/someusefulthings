...
public class ReinforcementMachineTileEntity extends TileEnergyHandler implements ITickable
{

	private static final int workTotalTime = 200;
	private static final int workRF = 20000;

	public ReinforcementMachineTileEntity()
	{
		this.storage = new EnergyStorage(10000000, 20000);
	}
