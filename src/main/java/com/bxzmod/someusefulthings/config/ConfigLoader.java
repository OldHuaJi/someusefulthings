...
public class ConfigLoader 
{
    ...
    public static void load()
    {
        ...
        invincible_ring = config.get(Configuration.CATEGORY_GENERAL, "invincible ring", true, comment[id++]).getBoolean();
        ...
        portable_inventory_item = config.get(Configuration.CATEGORY_GENERAL, "backpack", true, comment[id++]).getBoolean();
        
        comment[id] = "Enable copy enchantment?(default=true)";
        copy_enchantment = config.get(Configuration.CATEGORY_GENERAL, "copy enchantment", true, comment[id++]).getBoolean();
        
        comment[id] = "Enable reinforcement machine?(default=true)";
        reinforcement_machine = config.get(Configuration.CATEGORY_GENERAL, "reinforcement machine", true, comment[id++]).getBoolean();
        
        comment[id] = "Enable remove enchantment?(default=true)";
        remove_enchantment = config.get(Configuration.CATEGORY_GENERAL, "remove enchantment", true, comment[id++]).getBoolean();
        ...
        command_easyset = config.get(Configuration.CATEGORY_GENERAL, "command easyset", true, comment[id++]).getBoolean();
